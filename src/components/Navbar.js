  ...
  return (
    ...
    >
      ...
      <div className="flex items-center invisible md:visible">
        <div className="animate-fade-in-down-delay-200 opacity-0">
          <NavbarItem routeName="/">Home</NavbarItem>
        </div>
        <div className="animate-fade-in-down-delay-300 opacity-0">
        ...
        <div className="animate-fade-in-down-delay-500 opacity-0 ml-5 mr-10">
          <NavLink to="/resume">
