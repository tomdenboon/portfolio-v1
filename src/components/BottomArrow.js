...
function BottomArrow() {
    return ( 
    <div className="group absolute bottom-4 flex flex-col items-center justify-center cursor-pointer transform hover:translate-y-2 duration-500 
        animate-fade-in-up-delay-800 opacity-0">
